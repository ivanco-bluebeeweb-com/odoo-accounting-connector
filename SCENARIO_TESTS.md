# Plausible Scenario Tests (PST) — Odoo Accounting Connector
...
- `connect_odoo_accounting`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_odoo_accounting`: validated contract & error handling
