"""Settings panel for Odoo Accounting Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__odoo_accounting_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=odoo_accounting_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_odoo_accounting"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Odoo Accounting Settings & Accounts", level=2),
